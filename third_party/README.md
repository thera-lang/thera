...
- the vendored files themselves, preserving the upstream layout where
  practical.

Vendoring here is for substantial imports — a test corpus, a data set. A
minor include (a constant, a table, a few lines with an attribution comment)
does not need a directory here.
