...
//!
//! 1. **Embed the front-end.** If `HAWK_FRONTEND_BC` points at a `.hawkbc` file,
//!    copy it to `$OUT_DIR/frontend.hawkbc`; otherwise write a 0-byte stub. The
...
fn main() {
    ...
    let dest = out_dir.join("frontend.hawkbc");
